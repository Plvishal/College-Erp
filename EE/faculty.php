...
<div class="flex-container space-between">
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/anurag.jpeg">
    </div>
    <div>
      <h3>Dr.Anurag Dwivedi</h3>
  ...
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/anand.jpeg">
    </div>
    <div>
      <h3>Anand Singh </h3>
...
<div class="flex-container space-between">
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/vishakh.jpeg">
    </div>
    <div>
      <h3>Vishakh Giri</h3>
      <p><i class="fa-solid fa-user"></i>B.Tech, M.Tech</p>
  ...
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/archana.jpeg">
    </div>
    <div>
      <h3>Archana Pal</h3>
      <p><i class="fa-solid fa-user"></i> MBA</p>
      <p><i class="fa-solid fa-paper-plane"></i> Designation: Faculty</a></p>
      <p><i class="fa-solid fa-location-dot"></i> Lucknow</p>
    </div>
  </div>
...
<div class="flex-container space-between">
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/rachit.jpg">
    </div>
    <div>
      <h3>Dr. Rachit Srivastva</h3>
      <p><i class="fa-solid fa-user"></i>B.Tech , M.Tech, Ph.D</p>
      <p><i class="fa-solid fa-paper-plane"></i>  Designation: Faculty</a></p>
      <p><i class="fa-solid fa-location-dot"></i> Lucknow</p>
    </div>
  ...
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/jay.jpeg">
    </div>
    <div>
      <h3>Jay Bhadur Singh</h3>
      <p><i class="fa-solid fa-user"></i>B.Tech , M.Tech, Ph.D</p>
      <p><i class="fa-solid fa-paper-plane"></i>  Designation: Faculty</a></p>
      <p><i class="fa-solid fa-location-dot"></i> Lucknow</p>
    </div>
...
<div class="flex-container space-between">
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/tej.webp">
    </div>
    <div>
      <h3>Tej Prakash Verma</h3>
      <p><i class="fa-solid fa-user"></i>B.Tech , M.Tech, Ph.D</p>
      <p><i class="fa-solid fa-paper-plane"></i>  Designation: Faculty</a></p>
      <p><i class="fa-solid fa-location-dot"></i> Lucknow</p>
    </div>
  ...
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/rajesh-kumar.webp">
    </div>
    <div>
      <h3>Rajesh Kumar</h3>
      <p><i class="fa-solid fa-user"></i>B.Tech , M.Tech</p>
...
<div class="flex-container space-between">
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/arun.webp">
    </div>
    <div>
      <h3>Arun Kumar Yadav</h3>
      <p><i class="fa-solid fa-user"></i>B.Tech , M.Tech</p>
      <p><i class="fa-solid fa-paper-plane"></i>  Designation: Faculty</a></p>
      <p><i class="fa-solid fa-location-dot"></i> Lucknow</p>
    </div>
