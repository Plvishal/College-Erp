...
<div class="flex-container space-between">
  ...
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/adarsh-sisss.jpg">
    </div>
    <div>
      <h3>Adarsh Kumar </h3>
...
<div class="flex-container space-between">
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/jabbar.jpg">
    </div>
    <div>
      <h3>Abdul Jabbar Ansari</h3>
  ...
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/nikhil.jpg">
    </div>
    <div>
      <h3>Nikhil Bajpai </h3>
      <p><i class="fa-solid fa-user"></i> B.Tech. M.Tech</p>
...
<div class="flex-container space-between">
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/pravesh.jpg">
    </div>
    <div>
      <h3>Pravesh Kumar Singh </h3>
      <p><i class="fa-solid fa-user"></i>B.Tech , M.Tech</p>
      <p><i class="fa-solid fa-paper-plane"></i>  Designation: Faculty</a></p>
      <p><i class="fa-solid fa-location-dot"></i> Lucknow</p>
    </div>
  ...
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/r.k-sir.jpg">
    </div>
    <div>
      <h3> Ravindra Kumar Singh  </h3>
...
<div class="flex-container space-between">
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/umesh-yadav.jpeg">
    </div>
    <div>
      <h3> Umesh Kumar Yadav</h3>
      <p><i class="fa-solid fa-user"></i>B.Tech , M.Tech</p>
      <p><i class="fa-solid fa-paper-plane"></i>  Designation: Faculty</a></p>
      <p><i class="fa-solid fa-location-dot"></i> Lucknow</p>
    </div>
