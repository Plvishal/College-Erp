...
<?php include "../common/common-header.php"?>
    <div class="container mt-4">
        <div class="text-danger text-center m-auto">
            <img src="../Images/biet1.png" alt="" width="100" height="100">
            <h4 class="text-dark mt-3">BANSAL INSTITUTE OF ENGINEERING & TECHNOLOGY</h4>
            <h4 class="text-dark">Near Seva Hospital, Sitapur Road - Lucknow 226021.</h4>
        </div>
    </div>
    <div class="container-fluid mb-4 text-dark">
        ...
        <div class="d-flex mt-3">
            <div>
                <h5>Student Name : <?php echo ucwords(@$row['first_name']). " ". @$row['middle_name']. " ". @$row['last_name']; ?></h5>
                        ...
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <tr>
                                    ...
                                    <th colspan="2"><?php echo $total_ch > 0 ? round($total_quality_points/$total_ch, 2) : ''; ?></th>
                                </tr>
                            </table>
                        </div>
                    </section>
