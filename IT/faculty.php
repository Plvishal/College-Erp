...
<div class="flex-container space-between">
  ...
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/viveksir.jpeg">
    </div>
    <div>
      <h3>Vivek Singh </h3>
...
<div class="flex-container space-between">
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/pragyasir.jpg">
    </div>
    <div>
      <h3>Pragyadeep Singh</h3>
      <p><i class="fa-solid fa-user"></i>B.Tech, M.Tech</p>
      <p><i class="fa-solid fa-paper-plane"></i> Designation: Faculty</a></p>
      <p><i class="fa-solid fa-location-dot"></i> Lucknow</p>
    </div>
...
<div class="flex-container space-between">
  <div class="col card">
    ...
    <div>
      <h3>Reshu Singh</h3>
      <p><i class="fa-solid fa-user"></i>B.Com , M.Com</p>
      <p><i class="fa-solid fa-paper-plane"></i>  Designation: Faculty</a></p>
      <p><i class="fa-solid fa-location-dot"></i> Lucknow</p>
    </div>
  </div>
