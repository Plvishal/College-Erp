...
<div class="flex-container space-between">
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/clp.jpeg">
    </div>
    <div>
      <h3>Dr. C.L.P Gupta</h3>
  ...
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/madan.jpg">
    </div>
    <div>
      <h3>Madan Kushwaha </h3>
...
<div class="flex-container space-between">
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/manish-sir-photo.jpeg">
    </div>
    <div>
      <h3>Manish Kumar Soni</h3>
      <p><i class="fa-solid fa-user"></i>B.Tech, M.Tech</p>
      <p><i class="fa-solid fa-paper-plane"></i> Designation: Faculty</a></p>
      <p><i class="fa-solid fa-location-dot"></i> Lucknow</p>
    </div>
  ...
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/sushil.jpg">
    </div>
    <div>
      <h3>Sushil Kumar Maurya</h3>
      <p><i class="fa-solid fa-user"></i> B.Tech. M.Tech</p>
      <p><i class="fa-solid fa-paper-plane"></i> Designation: Faculty</a></p>
      <p><i class="fa-solid fa-location-dot"></i> Lucknoe</p>
    </div>
  </div>
</div>
<div class="flex-container space-between">
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/priyanka.jpg">
    </div>
    <div>
      <h3>Priyanka Goswami</h3>
  ...
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/hannan.jpg">
    </div>
    <div>
      <h3> Hannan Ansari  </h3>
...
<div class="flex-container space-between">
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/ram.jpg">
    </div>
     <div>
      <h3>Ram Kailash Gupta</h3>
      <p><i class="fa-solid fa-user">B.Tech, M.Tech</p>
      <p><i class="fa-solid fa-paper-plane"></i> Designation: Faculty</a></p>
      <p><i class="fa-solid fa-location-dot"></i> Lucknow</p>
    </div>
  </div>
  <div class="col card">
    <div class="img-placeholder">
      <img src="faculty_img/shashank.jpg">
    </div>
    <div>
      <h3> Shashank Gaur </h3>
      <p><i class="fa-solid fa-user">B.Tech,M.Tech</i></p>
