					...
					<div class="col-md-12">
						...
						<form action="asign-single-student-subjects.php" method="post">
							<div class="row mt-3">
								...
								<div class="col-sm-8">
    								<button class="btn btn-success px-5 my-1 float-right" onclick="document.getElementById('myForm').submit();" type="button" >Assign Subject to Student</button>
								</div>
							</div>	
						</form>
					</div>
								...
								<?php  
									...
									if (isset($_POST['submit'])) {
                                        ...
                                        while ($row=mysqli_fetch_array($run)) {
                                            $count++;
                                ?>
                                    <form action="asign-single-student-subjects.php" id="myForm" method="post">
                                        <tr>
                                            <td><?php echo $i++ ?></td>
